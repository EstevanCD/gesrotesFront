...
function Documents() {
  ...
  const getIconByExtension = (extension) => {
    switch (extension) {
      case "pdf":
        return <FontAwesomeIcon style={{ color: "#980c0f" ,fontSize: "30px" }} icon={faFilePdf} />;
      case "doc":
      case "docx":
        return <FontAwesomeIcon style={{ color: "#0a2167", fontSize: "30px" }} icon={faFileWord} />;
      case "xls":
      case "xlsx":
        return <FontAwesomeIcon style={{ color: "#007a29", fontSize: "30px" }} icon={faFileExcel} />;
      default:
        return null;
    }
  };
    ...
    <div className={style.containerDocuments}>
      <div className={style.containerSearchBar}>
        <div className={style.buttonNewDocument}>
          <button className={style.buttonND}>
            {" "}
            <i>
