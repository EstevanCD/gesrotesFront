...
import { Grid, Box, FormControl, InputLabel, Select, MenuItem, Alert, FormHelperText } from "@mui/material";
...
function ClassManageGroups() {
    ...
    return (
        <>
            <Card sx={{ m: 1 }}>
                <br></br>
                <Grid sx={{ m: 1 }} container spacing={0} alignItems="center" justifyContent="center">
                    <Grid item xs={6} md={6}>
                        <Typography>PASO 1: Seleccione el grupo al que le va a registrar estudiantes</Typography>
                    ...
                    <Grid item xs={6} md={6}>
                        <Typography>PASO 2: Seleccione los estudiantes que va a registrar en el grupo seleccionado</Typography>
                        <Box sx={{ minWidth: 120, maxWidth: 400 }}>
                            <FormControl fullWidth>
                ...
                <Grid container spacing={10} justifyContent="center">
                    <Grid item xs={12} md={12}>
                        <Typography textAlign="center">Lista de Grupos con Estudiantes</Typography>
                                    ...
                                    {groups1.map((row) => (
                                        ...
                                        >
                                            ...
                                            <TableCell align="center">
                                                <Box sx={{ maxWidth: 200 }}>
                                                    <Alert size="small" onClose={() => { }} severity="info">{row.name}</Alert>
                                                </Box>
                                            </TableCell>
